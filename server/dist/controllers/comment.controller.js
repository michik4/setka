...
class CommentController {
    constructor() {
        ...
        this.getPostCommentsCount = async (req, res) => {
            try {
                const postId = Number(req.params.postId);
    ...
    get commentRepository() {
        return db_connect_1.AppDataSource.getRepository(comment_entity_1.Comment);
    }
    get postRepository() {
        return db_connect_1.AppDataSource.getRepository(post_entity_1.Post);
    }
    get userRepository() {
        return db_connect_1.AppDataSource.getRepository(user_entity_1.User);
    }
    get groupMemberRepository() {
        return db_connect_1.AppDataSource.getRepository(group_member_entity_1.GroupMember);
    }
}
