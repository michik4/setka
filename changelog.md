...
> `{релиз версия}`.`{версия с дополнениями}`.`{bugfix версия/ UI/UX fix версия}``{буквенные версии}` <br>
> масштаб обновления идет слева направо от самых значительных до минимальных <br>
> - релиз версия - версия прошедшая все этапы разработок и тестирования
> - версия с дополнениями - добавление функций меняющий пользовательский опыт
> - bugfix версия - исправление багов и недочетов UI/UX
